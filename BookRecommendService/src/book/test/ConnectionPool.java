...
public final class ConnectionPool {
 ...
 // Storage for the allocated connections.
    ...
    public static ConnectionPool getInstance(String url, String user, String password, int initialCons, int maxCons, boolean block,long timeout) throws SQLException 
    {
 //   	pool = (pool == null) ? new ConnectionPool(url, user, password, initialCons, maxCons, block, timeout) : pool;
