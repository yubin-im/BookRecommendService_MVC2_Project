...
<%	
		...
		content += "<p>다음 링크를 클릭하여 이메일 인증을 완료하세요:</p>";
...
<section class="container mt-3" style="background-color: #f8f9fa;">
    <div class="alert alert-success mt-4" role="alert" style="background-color: #d4edda; border-color: #c3e6cb; color: #155724;">
        ...
        <p class="mb-0">회원가입 시 입력한 이메일을 확인하셔서 인증해주세요.</p>
        <p class="mb-0">이메일을 받지 못하셨다면 이메일 확인 후 다시 시도해주세요.</p>
        <p><a href = "<%=request.getContextPath() %>/login/registerForm.jsp">회원가입 화면으로 돌아가기</a></p>
    </div>
</section>
</body>
</html>