...
<%
   ...
   ArrayList<BooksDTO> recommBooks = bookDAO.selectRecommBookPaging(request, login.getGenre1(), login.getGenre2());
...
<head>
<meta charset="UTF-8">
<title>recommBookPaging</title>
</head>
<body>
<jsp:forward page="/myPage/viewRecommBookPaging.jsp"/>
</body>
</html>